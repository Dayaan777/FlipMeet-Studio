          ...
          <div className="flex items-center gap-4 md:gap-8">
            ...
            <div className="min-w-0 flex-1">
              <div className="relative mx-auto h-[30rem] w-full max-w-4xl [perspective:1200px] sm:h-[34rem]" aria-live="polite">
                <div aria-hidden="true" className="pointer-events-none absolute bottom-[7.25rem] left-1/2 z-0 h-[4.5rem] w-[104%] -translate-x-1/2 rounded-[50%] bg-[radial-gradient(ellipse_at_50%_38%,rgba(255,255,255,0.12)_0%,rgba(255,77,30,0.16)_18%,rgba(25,25,25,0.98)_52%,rgba(3,3,3,1)_100%)] shadow-[0_10px_18px_rgba(0,0,0,0.8),0_0_42px_rgba(255,77,30,0.12),0_0_80px_rgba(255,77,30,0.08),inset_0_3px_7px_rgba(255,255,255,0.12),inset_0_-10px_14px_rgba(0,0,0,0.72)] [transform:translateX(-50%)_perspective(900px)_rotateX(58deg)] after:absolute after:inset-[3px] after:rounded-[50%] after:bg-[radial-gradient(ellipse_at_50%_25%,rgba(255,255,255,0.08),transparent_42%,rgba(0,0,0,0.22)_100%)] sm:bottom-[7.75rem] sm:h-20 sm:w-[104%]" />
