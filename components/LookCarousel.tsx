    ...
    <section className="overflow-hidden border-b border-base-border px-6 py-24">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="relative">
          <div className="pointer-events-none absolute inset-x-[7%] bottom-[4.5rem] h-28 rounded-[50%] border border-text-secondary/70 bg-[radial-gradient(ellipse_at_center,rgba(255,77,30,0.1)_0%,rgba(0,0,0,0.22)_42%,rgba(0,0,0,0)_70%)] shadow-[0_16px_30px_rgba(0,0,0,0.9),inset_0_3px_0_rgba(255,255,255,0.18),inset_0_-12px_20px_rgba(0,0,0,0.85),0_0_22px_rgba(255,77,30,0.12)] sm:inset-x-[13%]" />
          <div className="pointer-events-none absolute inset-x-[9%] bottom-[4.85rem] h-20 rounded-[50%] border border-accent/35 shadow-[0_0_18px_rgba(255,77,30,0.22),inset_0_5px_9px_rgba(255,255,255,0.12)] sm:inset-x-[15%]" />
          <div className="pointer-events-none absolute inset-x-[13%] bottom-[4.7rem] h-14 rounded-[50%] border border-text-primary/35 shadow-[inset_0_2px_4px_rgba(255,255,255,0.16),inset_0_-8px_12px_rgba(0,0,0,0.8)] sm:inset-x-[19%]" />
          <div className="pointer-events-none absolute inset-x-[12%] bottom-10 h-12 rounded-[50%] bg-[radial-gradient(ellipse_at_center,rgba(255,77,30,0.22)_0%,rgba(0,0,0,0.74)_48%,rgba(0,0,0,0)_75%)] blur-md sm:inset-x-[18%]" />
          <div className="pointer-events-none absolute inset-x-[14%] bottom-8 h-10 rounded-[50%] bg-black/75 blur-xl sm:inset-x-[20%]" />
